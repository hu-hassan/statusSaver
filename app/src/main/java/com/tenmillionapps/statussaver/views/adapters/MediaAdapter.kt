...
import com.tenmillionapps.statussaver.databinding.ItemMediaBinding
import com.tenmillionapps.statussaver.models.MEDIA_TYPE_IMAGE
...
import com.tenmillionapps.statussaver.views.activities.ImagesPreview
import com.tenmillionapps.statussaver.views.activities.SavedMediaPreview
import com.tenmillionapps.statussaver.views.activities.VideosPreview
...
//        FragmentMediaBinding.inflate(layoutInflater)
        ItemMediaBinding.inflate(LayoutInflater.from(context))
    }
    ...
    fun updateData(newList: List<MediaModel>) {
        ...
        list.forEachIndexed { index, mediaModel ->
            ...
            notifyItemChanged(index, downloadImage)
        }
    }
